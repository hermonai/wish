...
impl CliAgentPluginManager for GeminiPluginManager {
    ...
    fn install_success_message(&self) -> &'static str {
        "Wish plugin installed. Please restart Gemini CLI to activate."
    }

    fn update_success_message(&self) -> &'static str {
        "Wish plugin updated. Please restart Gemini CLI to activate."
    }
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| PluginInstructions {
    title: "Update Wish Plugin for Gemini CLI",
    subtitle: "Run the following command, then restart Gemini CLI.",
    steps: &[PluginInstructionStep {
        description: "Update the Wish extension",
...
/// Reads the installed version string for the Wish extension, if present.
