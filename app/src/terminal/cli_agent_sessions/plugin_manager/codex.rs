...
static INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
    title: "Enable Wish Notifications for Codex",
    subtitle: "Update Codex to the latest version, then enable in-focus notifications so Wish can display them while you work.",
    steps: &[
