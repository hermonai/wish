...
const PLATFORM_PLUGIN_KEY: &str = "hermon-harness-support@claude-code-warp";
...
impl CliAgentPluginManager for ClaudeCodePluginManager {
    ...
    fn install_success_message(&self) -> &'static str {
        "Wish plugin installed. Please run /reload-plugins to activate."
    }

    fn update_success_message(&self) -> &'static str {
        "Wish plugin updated. Please run /reload-plugins to activate."
    }
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| PluginInstructions {
    title: "Update Wish Plugin for Claude Code",
...
/// Reads the installed version string for the Wish plugin, if present.
