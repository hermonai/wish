use wish_completer::completer::{CommandOutput, GeneratorContext};
...
fn parse_dynamic_command(output: &CommandOutput) -> anyhow::Result<Vec<String>> {
    match output.status {
        wish_completer::completer::CommandExitStatus::Success => {
        ...
        wish_completer::completer::CommandExitStatus::Failure => {
