...
/// Whether this keystroke should dispatch an action in Wish despite the
/// [`wishui::event::Event::KeyDown::is_composing`] being true.
///
...
///
/// This function is intended to be used when handling [`wishui::event::Event::KeyDown`] when its
