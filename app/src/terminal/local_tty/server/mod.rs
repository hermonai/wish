//! Logic relating to a secondary process which Wish uses to spawn new shell
//! sessions.
//!
...
//! early during Wish's initialization, we can be more confident that there are
...
pub fn run_terminal_server(args: &wish_cli::TerminalServerArgs) {
...
/// between processes, enabling the Wish application process to communicate
    ...
    pub fn new() -> Result<Self> {
        ...
        unsafe {
            ...
            let server = Command::new(program)
                ...
                .arg(wish_cli::terminal_server_subcommand())
