...
pub fn get_cloud_mode_tips() -> Vec<CloudModeTip> {
    vec![
        ...
        CloudModeTip::new(
            "Set team or personal secrets for agents using the `hermon secret` command.",
        ...
        CloudModeTip::new(
            ...
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/triggers/scheduled-agents"),
        ),
        CloudModeTip::new(
            "Create agents that automatically fix bugs when issues are filed in Linear.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/integrations/linear"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            ...
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/environments"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            "Use the `--share` flag with the Wish CLI to enable session sharing from anywhere.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/platform"),
        ),
        CloudModeTip::new(
            "Fork a completed Hermon cloud agent session into Wish to continue the work locally.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/viewing-cloud-agent-runs"),
        ),
        CloudModeTip::new(
            "Build internal tools that use agents to answer questions from your databases.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/integrations"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            "Tag @Wish in Linear issues to automatically investigate and propose fixes.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/integrations/linear"),
        ),
        CloudModeTip::new(
            "Run agents on remote dev boxes or CI runners using the Wish CLI.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/platform"),
        ),
        CloudModeTip::new(
            "Configure MCP servers to give Wish cloud agents access to GitHub, Linear, and Sentry.",
            Some("https://wish.hermon.ai/docs/agent-platform/capabilities/mcp"),
        ),
        CloudModeTip::new(
            "Use `wish agent run` to kick off tasks without opening the Wish terminal.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/platform"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            "Use `hermon environment create` to define reproducible execution contexts.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/environments"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            ...
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/triggers"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            "Use `hermon schedule create` to set up cron-triggered agents.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/triggers/scheduled-agents"),
        ),
        CloudModeTip::new(
            "Pause and resume scheduled agents without deleting them using `hermon schedule pause`.",
            Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/triggers/scheduled-agents"),
        ),
        CloudModeTip::new(
            "Use `hermon mcp list` to see which MCP servers are available to your agents.",
            Some("https://wish.hermon.ai/docs/agent-platform/capabilities/mcp"),
        ),
        CloudModeTip::new(
