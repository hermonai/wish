...
use crate::{
    ...
    terminal::{
        ssh::wishify::wishify_description,
...
pub struct WishifyBannerState {
    ...
    pub initialize_wishify_keybinding: Option<Keystroke>,
    pub hover_state: MouseStateHandle,
}

impl WishifyBannerState {
    pub fn new(mode: WishificationMode, initialize_wishify_keybinding: Option<Keystroke>) -> Self {
        Self {
            mode,
            height: 0.0,
            initialize_wishify_keybinding,
...
pub fn render_warpification_banner(
    ...
    let yes_button = render_yes_button(
        state,
        &state.initialize_wishify_keybinding,
    ...
    render_block_banner(
        |hover_state| {
            ...
            {
                let description = Container::new(wishify_description(app, hyperlink_index))
