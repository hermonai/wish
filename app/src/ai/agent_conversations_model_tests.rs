...
fn test_harness_filter_matches_only_selected_harness() {
    App::test((), |mut app| async move {
        ...
        // Snapshot present but no harness set → Some(Oz), matches Wish Agent.
        ...
        // Local conversation: effectively Wish Agent.
        ...
        app.update(|ctx| {
            ...
            // Wish Agent / Oz → default-snapshot task and local conversation.
