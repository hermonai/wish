...
impl AIExecutionProfileInfo {
    ...
    /// The Wish Drive sync ID of this profile, if it has been synced.
    #[cfg_attr(target_family = "wasm", allow(dead_code))]
...
impl AIExecutionProfilesModel {
    ...
    pub fn create_profile(&mut self, ctx: &mut ModelContext<Self>) -> Option<ClientProfileId> {
        ...
        new_profile.autosync_plans_to_wish_drive = true;
    ...
    pub fn set_autosync_plans_to_wish_drive(
        &mut self,
        profile_id: ClientProfileId,
        enabled: bool,
        ctx: &mut ModelContext<Self>,
        ...
        self.edit_profile_internal(
            profile_id,
            |profile| {
                if profile.autosync_plans_to_wish_drive != enabled {
                    profile.autosync_plans_to_wish_drive = enabled;
                    return true;
                }
                false
            },
