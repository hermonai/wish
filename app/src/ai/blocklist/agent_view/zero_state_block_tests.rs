...
#[test]
fn hermon_updates_section_renders_when_all_conditions_are_true() {
    assert!(should_render_hermon_updates_section(true, true, true));
}

#[test]
fn hermon_updates_section_does_not_render_when_setting_is_disabled() {
    assert!(!should_render_hermon_updates_section(true, false, true));
}

#[test]
fn hermon_updates_section_does_not_render_without_updates() {
    assert!(!should_render_hermon_updates_section(true, true, false));
}

#[test]
fn hermon_updates_section_does_not_render_when_feature_flag_is_disabled() {
    assert!(!should_render_hermon_updates_section(false, true, true));
}
