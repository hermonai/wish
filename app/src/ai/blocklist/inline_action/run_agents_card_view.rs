...
impl RunAgentsCardView {
    ...
    fn ensure_pickers(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        let composited_bg = theme
            ...
            .into_solid();
        let picker_border_color_warpui: wishui::elements::Fill = theme.surface_2().into();
        let picker_font_color = blended_colors::text_main(theme, composited_bg);
        let picker_background_warpui: wishui::elements::Fill = picker_background_theme.into();
    ...
    fn new_standard_picker_dropdown(
        ...
        background: wishui::elements::Fill,
        border_color: wishui::elements::Fill,
        font_color: ColorU,
        ctx: &mut ViewContext<Self>,
...
impl View for RunAgentsCardView {
    ...
    fn keymap_context(&self, _app: &AppContext) -> wishui::keymap::Context {
...
fn render_segment_button(
    ...
    let segment_active_bg = wish_core::ui::theme::color::internal_colors::fg_overlay_4(theme);
