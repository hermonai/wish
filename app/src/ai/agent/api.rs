...
use wishui::{AppContext, EntityId, SingletonEntity as _};
...
pub struct RequestParams {
    ...
    pub allow_use_of_wish_credits_with_byok: bool,
...
impl RequestParams {
    pub fn new(
        ...
        let warp_drive_context_enabled = ai_settings.is_wish_drive_context_enabled(app);
        ...
        let custom_model_providers = FeatureFlag::CustomInferenceEndpoints
            ...
            .flatten();
        let allow_use_of_wish_credits_with_byok =
            *AISettings::as_ref(app).can_use_wish_credits_with_byok;
        ...
        Self {
            ...
            allow_use_of_wish_credits_with_byok,
            autonomy_level,
            isolation_level,
            web_search_enabled,
