...
use uuid::Uuid;
use wishui::{AppContext, Entity, EntityId, ModelContext, ModelHandle, SingletonEntity, WindowId};
...
use wish_multi_agent_api as maa_api;
...
impl AIDocumentEarlierVersion {
    pub fn get_content(&self, ctx: &wishui::AppContext) -> String {
