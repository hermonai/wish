...
fn render_pill_toggle(is_on: bool, theme: &WarpTheme) -> Box<dyn Element> {
    ...
    let track_bg = if is_on {
        ...
        wish_core::ui::theme::color::internal_colors::fg_overlay_4(theme).into_solid()
    };
...
impl View for OrchestrationConfigBlockView {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let header_row = Flex::row()
            .with_cross_axis_alignment(CrossAxisAlignment::Center)
            .with_child(wishui::elements::Expanded::new(1.0, header_label).finish())
            .with_child(
        ...
        if self.is_approved {
            ...
            let chevron_icon = if self.details_expanded {
                wish_core::ui::Icon::ChevronDown
            } else {
                wish_core::ui::Icon::ChevronRight
            };
            ...
            let chevron = ConstrainedBox::new(
                chevron_icon
                    .to_warpui_icon(wish_core::ui::theme::Fill::Solid(disabled_text_color))
                    .finish(),
            )
            .with_width(14.)
            .with_height(14.)
            ...
            let details_row = Flex::row()
                .with_cross_axis_alignment(CrossAxisAlignment::Center)
                .with_child(wishui::elements::Expanded::new(1.0, Empty::new().finish()).finish())
                .with_child(
            ...
            if self.details_expanded {
                ...
                let active_seg_bg =
                    wish_core::ui::theme::color::internal_colors::accent_overlay_2(theme);
                column.add_child(
        ...
        Container::new(column.finish())
            ...
            .with_background(wish_core::ui::theme::color::internal_colors::accent_overlay_1(theme))
            .with_border(wishui::elements::Border::all(1.).with_border_fill(theme.accent()))
            .finish()
    }
}
