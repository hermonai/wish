...
use wishui::elements::Shrinkable;
use wishui::platform::FilePickerConfiguration;
...
impl RuleView {
        ...
        Hoverable::new(mouse_state, move |state| {
            ...
            if is_selected {
                container = container
                    ...
                    .with_corner_radius(CornerRadius::with_all(wishui::elements::Radius::Pixels(
                        4.,
                    )));
    ...
    fn render_disabled_banner(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        .with_corner_radius(CornerRadius::with_all(wishui::elements::Radius::Pixels(4.)))
    ...
    fn render_sync_status_icon(
        ...
        let item = ai_row.fact.to_wish_drive_item(appearance)?;
