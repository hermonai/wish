...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/slash-commands".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/terminal/input/universal-input#input-modes".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/planning".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        AgentTip {
            description: "<keybinding> to open the Command Palette and access Wish actions and shortcuts.".to_string(),
            link: Some("https://wish.hermon.ai/docs/terminal/command-palette".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/knowledge-and-collaboration/warp-drive".to_string()),
            binding_name: None,
        ...
        AgentTip {
            description: "`@` to add context from files, blocks, or Wish Drive objects to your prompt.".to_string(),
            link: Some("https://wish.hermon.ai/docs/agent-platform/local-agents/agent-context/using-to-add-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/local-agents/agent-context/blocks-as-context#attaching-blocks-as-context".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/codebase-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/agent-profiles-permissions".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/local-agents/interacting-with-agents/conversation-forking".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/terminal/blocks/block-actions#copy-input-output-of-block".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/local-agents/agent-context/images-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/full-terminal-use".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/code/code-review".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/mcp".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/reference/cli/integration-setup".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/local-agents/interacting-with-agents".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        ...
        AgentTip {
            description: "Use the `hermon` command to run an Hermon agent in headless mode, useful for remote machines.".to_string(),
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/rules#project-rules-1".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/local-agents/agent-context/urls-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/capabilities/full-terminal-use#session-level-approvals".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://wish.hermon.ai/docs/agent-platform/cloud-agents/managing-cloud-agents#in-app-agent-notifications".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
...
impl WorkspaceAction {
    pub fn display_text(&self) -> Option<String> {
        match self {
            ...
            WorkspaceAction::OpenWarpDrive => Some("Wish Drive.".to_string()),
        ...
        && AISettings::as_ref(ctx).is_voice_input_enabled(ctx)
    {
        tips.push(AgentTip {
            description: "Hold <keybinding> to speak your prompt directly to the agent."
                .to_string(),
            link: Some(
                "https://wish.hermon.ai/docs/agent-platform/local-agents/interacting-with-agents/voice"
                    .to_string(),
            ),
...
impl AITipModel<AgentTip> {
    ...
    pub fn maybe_refresh_tip(
        ...
        let handle = ctx.spawn(
            async {
                wishui::r#async::Timer::after(Duration::from_secs(60)).await;
            },
            |me, _, _| {
