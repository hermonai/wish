...
use wishui::elements::{ChildView, Element, Empty, ParentElement, Wrap};
use wishui::{AppContext, Entity, TypedActionView, View, ViewContext, ViewHandle};
    ...
    for artifact in artifacts {
        match artifact {
            Artifact::Plan {
                ...
                // Only show plan button if synced to Wish Drive (has notebook_uid)
