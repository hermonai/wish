...
impl TemplatableMCPServerManager {
    ...
    /// Updates a TemplatableMCPServer in Wish Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Gets all TemplatableMCPServers currently in Wish Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Creates a new TemplatableMCPServer in Wish Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Deletes a TemplatableMCPServer from Wish Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
