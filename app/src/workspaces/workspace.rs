...
use wish_graphql::billing::{AddonCreditAutoReloadStatus, ServiceAgreement, ServiceAgreementType};
...
impl Workspace {
    ...
    pub fn get_auto_reload_price_cents(
        &self,
        addon_credits_options: &[wish_graphql::billing::AddonCreditsOption],
    ) -> Option<i32> {
