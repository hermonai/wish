...
use wishui::{presenter::ChildView, ViewContext, ViewHandle};
use wishui::{FocusContext, ModelHandle};
...
impl CodeEditorFind {
    ...
    fn render_next_match_button(
        ...
        Container::new(
            ConstrainedBox::new(match_icon.to_wishui_icon(icon_color).finish())
                .with_height(height)
                .with_width(height)
                .finish(),
        )
    ...
    fn render_search_button(
        ...
        Container::new(
            ConstrainedBox::new(Icon::Search.to_wishui_icon(icon_color).finish())
                .with_height(height)
                .with_width(height)
                .finish(),
        )
...
impl View for CodeEditorFind {
    ...
    fn on_blur(&mut self, _blur_ctx: &wishui::BlurContext, ctx: &mut ViewContext<Self>) {
