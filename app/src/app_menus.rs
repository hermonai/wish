...
const SHOW_SSH_COMMAND_BLOCKS_MENU_ITEM_NAME: &str = "Show Wishified SSH Blocks";
const HIDE_SSH_COMMAND_BLOCKS_MENU_ITEM_NAME: &str = "Hide Wishified SSH Blocks";
...
/// Dispatch event to open a new Wish window
