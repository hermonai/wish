...
use wish_graphql::experiment::Experiment;
...
impl Display for ServerExperiment {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let str = match self {
            ...
            Self::TmuxSshWishificationControl => "TMUX_SSH_WARPIFICATION_CONTROL",
            Self::TmuxSshWishificationExperiment => "TMUX_SSH_WARPIFICATION_EXPERIMENT",
...
impl ServerExperiment {
    pub fn from_string(s: String) -> Result<Self> {
        match s.as_str() {
            ...
            "TMUX_SSH_WARPIFICATION_CONTROL" => Ok(Self::TmuxSshWishificationControl),
            "TMUX_SSH_WARPIFICATION_EXPERIMENT" => Ok(Self::TmuxSshWishificationExperiment),
...
impl TryFrom<Experiment> for ServerExperiment {
    ...
    fn try_from(value: Experiment) -> Result<Self, Self::Error> {
        match value {
            ...
            Experiment::TmuxSshWarpificationControl => Ok(Self::TmuxSshWishificationControl),
            Experiment::TmuxSshWarpificationExperiment => Ok(Self::TmuxSshWishificationExperiment),
