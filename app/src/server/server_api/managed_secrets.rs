...
use wish_graphql::mutations::issue_task_identity_token::{
...
use wish_graphql::queries::managed_secret_config::{
    GetManagedSecretConfig, GetManagedSecretConfigVariables, UserResult,
};
use wish_graphql::queries::task_secrets::{
...
use wish_managed_secrets::client::{SecretOwner, TaskIdentityToken};

use super::ServerApi;
use crate::server::graphql::{get_request_context, get_user_facing_error_message};

pub use wish_managed_secrets::client::{ManagedSecretConfigs, ManagedSecretsClient};
...
impl ManagedSecretsClient for ServerApi {
    ...
    async fn issue_task_identity_token(
        &self,
        options: wish_managed_secrets::client::IdentityTokenOptions,
