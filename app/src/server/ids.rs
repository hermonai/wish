// Re-export types from wish_server_client.
pub use wish_server_client::ids::{
...
/// For types defined in wish_server_client, use `wish_server_client::server_id_traits!` instead.
#[macro_export]
