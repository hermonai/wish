...
use wish_core::channel::RudderStackDestination;
use wishui::telemetry::Event;
...
pub fn clear_event_queue() {
    let _ = wishui::telemetry::flush_events();
}
...
impl TelemetryApi {
    ...
    pub async fn flush_events(&self, settings_snapshot: PrivacySettingsSnapshot) -> Result<usize> {
        let events = wishui::telemetry::flush_events();
    ...
    pub async fn send_telemetry_event(
        ...
        anonymous_id: String,
        event: impl wish_core::telemetry::TelemetryEvent,
        settings_snapshot: PrivacySettingsSnapshot,
    ) -> Result<()> {
        let event = wishui::telemetry::create_event(
