...
/// user to have logged in, or for the initial load of Wish Drive objects to have finished). When
...
///
/// We use this in Wish Drive to wait for the initial load of changed objects to finish. Regular UI
