...
```
cd <repo root>
diesel migration run --database-url="/Users/$USER/Library/Application Support/ai.hermon.Wish-Local/warp.sqlite"
```
...
```
diesel print-schema --database-url="/Users/$USER/Library/Application Support/ai.hermon.Wish-Local/warp.sqlite"
```
...
```
diesel migration revert --database-url="/Users/$USER/Library/Application Support/ai.hermon.Wish-Local/warp.sqlite"
diesel migration redo --database-url="/Users/$USER/Library/Application Support/ai.hermon.Wish-Local/warp.sqlite"
```
