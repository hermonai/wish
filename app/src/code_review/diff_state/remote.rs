...
impl wishui::Entity for RemoteDiffStateModel {
...
impl RemoteDiffStateModel {
    ...
    pub fn is_git_operation_blocked(&self, _ctx: &wishui::AppContext) -> bool {
        false
    }
