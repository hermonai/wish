...
use wishui::{Entity, EntityId, ModelContext, SingletonEntity, WindowId};
...
/// in Wish from Finder, or when starting from a cloud object). In that case, the `ActiveSession`
