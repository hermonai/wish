    ...
    pub fn is_any_non_palette_modal_open(&self, app: &AppContext) -> bool {
        self.is_theme_creator_modal_open
            ...
            || {
                ...
                one_time_modal.is_hermon_launch_modal_open()
...
/// that.
///
/// Note that "active" is not the same as "focused" in Wish's pane management.
