...
fn preferred_agent_tab_titles_default_to_title_like_text() {
    let agent_text = TerminalAgentText {
        conversation_display_title: Some("Generated Hermon Agent title".to_string()),
    ...
    assert_eq!(
        ...
        (
            Some("Generated Hermon Agent title".to_string()),
...
fn preferred_agent_tab_titles_use_latest_prompt_when_enabled() {
    ...
    assert_eq!(
        ...
        (
            Some("Latest Hermon Agent prompt".to_string()),
...
#[test]
fn detail_sidecar_supports_terminal_code_and_wish_drive_object_panes() {
