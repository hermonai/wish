...
pub fn has_feature_gated_anonymous_user_reached_notebook_limit<V: wishui::View>(
...
pub fn has_feature_gated_anonymous_user_reached_workflow_limit<V: wishui::View>(
    ctx: &mut ViewContext<V>,
) -> bool {
    let count = CloudModel::handle(ctx).read(ctx, |model, ctx| {
        model
...
pub fn has_feature_gated_anonymous_user_reached_env_var_limit<V: wishui::View>(
    ctx: &mut ViewContext<V>,
) -> bool {
    let count = CloudModel::handle(ctx).read(ctx, |model, ctx| {
        model
