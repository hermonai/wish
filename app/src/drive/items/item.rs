    ...
    fn default(appearance: &Appearance) -> WarpDriveItemStyles {
        ...
        WarpDriveItemStyles {
            ...
            dragged: UiComponentStyles::default()
                ...
                .set_background(
                    wish_core::ui::theme::color::internal_colors::fg_overlay_4(theme).into(),
                )
            ...
            hovered: UiComponentStyles::default()
                ...
                .set_background(
                    wish_core::ui::theme::color::internal_colors::fg_overlay_2(theme).into(),
                ),
        }
    }
}
...
impl<'a> WarpDriveRow<'a> {
    ...
    fn render_shared_object_owner(
        ...
        let icon = Container::new(
            ConstrainedBox::new(Icon::Users.to_wishui_icon(text_color).finish())
                .with_height(15.)
                .with_width(15.)
                .finish(),
        )
    ...
    fn render_chevron(&self, style: UiComponentStyles) -> Box<dyn Element> {
        ...
        if let Some(is_open) = self.item.is_folder_open() {
            ...
            Container::new(
                ConstrainedBox::new(chevron_icon.to_wishui_icon(icon_color.into()).finish())
                    .with_width(16.)
                    .with_height(16.)
                    .finish(),
            )
...
/// Generate a callback for calculating the Drag bounds within Wish Drive
