...
use wishui::text::{point::Point, words::is_default_word_boundary, BufferIndex, TextBuffer};
...
impl TextStyleOperation {
    ...
    /// use wishui::color::ColorU;
    /// use wishui::text_layout::TextStyle;
    /// use wish::editor::TextStyleOperation;
...
impl Buffer {
    ...
    /// use wish::Assets;
    /// use wish::editor::model::buffer::{Buffer, TextStyleOperation, EditOrigin};
