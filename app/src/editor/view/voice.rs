...
use wishui::elements;
use wishui::elements::{Container, CornerRadius, Icon, Radius};
...
use wishui::{AppContext, Element, SingletonEntity, ViewContext};
...
impl EditorView {
        ...
        ctx.subscribe_to_view(&voice_new_feature_popup, |_me, _, event, ctx| {
            if matches!(
                ...
                AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    wish_core::report_if_error!(settings
    ...
    fn render_voice_transcription_button_tooltip(
        ...
        let mic_access_denied = matches!(
            ...
            wishui::platform::MicrophoneAccessState::Restricted
                | wishui::platform::MicrophoneAccessState::Denied
        );
    ...
    pub(super) fn render_voice_transcription_button(
        ...
        wishui::elements::SavePosition::new(
            button
                .build()
