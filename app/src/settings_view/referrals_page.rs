...
const HEADER_TEXT: &str = "Invite a friend to Wish";
const ANONYMOUS_USER_HEADER_TEXT: &str = "Sign up to participate in Wish's referral program";
...
const REWARD_INTRO: &str = "Get exclusive Wish goodies when you refer someone*";
...
const TERMS_URL: &str =
    "https://wish.hermon.ai/docs/support-and-community/community/refer-a-friend#referral-program-terms-and-conditions";
const TERMS_CONTACT_TEXT: &str =
    " If you have any questions about the referral program, please contact support@hermon.ai.";
