...
const WARP_INDEXING_IGNORE_DESCRIPTION: &str = "To exclude specific files or directories from indexing, add them to the .wishindexingignore file in your repository directory. These files will still be accessible to AI features, but they won't be included in codebase embeddings.";
                ...
                Flex::row()
                    ...
                    .with_child(
                        Container::new(
                            ConstrainedBox::new(
                                Icon::SlashCircle
                                    .to_wishui_icon(ThemeFill::Solid(status_color))
                                    .finish(),
                            )
    ...
    fn render_index_status_parts(
        ...
        let (status_text, status_color) = if index_state.has_pending() {
            ...
            label_row.add_child(
                Container::new(
                    ConstrainedBox::new(
                        status_icon.to_wishui_icon(ThemeFill::Solid(color)).finish(),
                    )
                    .with_width(STATUS_ICON_SIZE)
                    .with_height(STATUS_ICON_SIZE)
                    .finish(),
