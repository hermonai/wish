                            ...
                            appearance
                                ...
                                .with_text_and_icon_label(
                                    TextAndIcon::new(
                                        ...
                                        "Manage billing",
                                        Icon::CoinsStacked.to_wishui_icon(fg_color),
                                        MainAxisSize::Min,
                        ...
                        appearance
                            ...
                            .with_text_and_icon_label(
                                TextAndIcon::new(
                                    TextAndIconAlignment::IconFirst,
                                    "Open admin panel",
                                    Icon::Users.to_wishui_icon(fg_color),
                                    MainAxisSize::Min,
                                    MainAxisAlignment::Center,
                                    vec2f(14., 14.),
                                )
                ...
                (false, true, true) => {
                    ...
                    Some(
                        ...
                        .register_default_click_handlers_with_action_support(|lens, event, ctx| {
                            match lens {
                                wishui::elements::HyperlinkLens::Url(u) => ctx.open_url(u),
                                wishui::elements::HyperlinkLens::Action(a) => {
                                    if let Some(act) =
...
impl From<wishui::ViewHandle<BillingAndUsagePageV2View>> for SettingsPageViewHandle {
    fn from(view_handle: wishui::ViewHandle<BillingAndUsagePageV2View>) -> Self {
