...
static SAFE_MODE_DESCRIPTION: LazyLock<&'static str> = LazyLock::new(|| {
    "When this setting is enabled, Wish will scan blocks, the contents of \
        Wish Drive objects, and Hermon Agent prompts for potential sensitive \
...
const TELEMETRY_TITLE: &str = "Help improve Wish";
const TELEMETRY_DESCRIPTION: &str =
    "App analytics help us make the product better for you. We may collect \
    certain console interactions to improve Wish's AI capabilities.";
...
const TELEMETRY_DOCS_URL: &str =
    "https://wish.hermon.ai/docs/support-and-community/privacy-and-security/privacy#what-telemetry-data-does-warp-collect-and-why";

const DATA_MANAGEMENT_TITLE: &str = "Manage your data";
const DATA_MANAGEMENT_DESCRIPTION: &str =
    "At any time, you may choose to delete your Wish account permanently. \
    You will no longer be able to use Wish.";
const DATA_MANAGEMENT_LINK_TEXT: &str = "Visit the data management page";

const PRIVACY_POLICY_TITLE: &str = "Privacy policy";
const PRIVACY_POLICY_LINK_TEXT: &str = "Read Wish's privacy policy";
...
impl SecretRedactionWidget {
    ...
    fn add_button(text: impl Into<Cow<'static, str>>, appearance: &Appearance) -> TextAndIcon {
        TextAndIcon::new(
            ...
            text,
            Icon::Plus.to_wishui_icon(appearance.theme().active_ui_text_color()),
            MainAxisSize::Min,
...
impl SettingsWidget for AppAnalyticsWidget {
    ...
    fn should_render(&self, app: &AppContext) -> bool {
        // Builds without a telemetry config (e.g. OpenWish) cannot ship
    ...
    fn render(
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        "Read more about Wish's use of data".into(),
...
impl SettingsWidget for CrashReportsWidget {
    ...
    fn should_render(&self, app: &AppContext) -> bool {
        // Builds without a crash reporting config (e.g. OpenWish) cannot ship
                ...
                ui_builder
                    .paragraph(
                        if is_checked {
                            ...
                            for product functionality, and Wish will not use it for analytics."
                        } else {
...
fn description_text_color(theme: &WarpTheme) -> wish_core::ui::theme::Fill {
