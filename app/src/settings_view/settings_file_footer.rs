...
pub fn render_open_settings_file_button(
    ...
    Hoverable::new(mouse_state, move |state| {
        let icon = ConstrainedBox::new(Icon::Code2.to_wishui_icon(text_fill).finish())
...
pub fn render_settings_error_alert(
    ...
    // `ClippedScrollable` wants `wishui::elements::Fill` (not the theme
    ...
    let scrollable_text = ConstrainedBox::new(
        ClippedScrollable::vertical(
            ...
            text_row,
            ScrollbarWidth::Auto,
            wishui::elements::Fill::Solid(coloru_with_opacity(text_color, 30)),
            wishui::elements::Fill::Solid(coloru_with_opacity(text_color, 60)),
