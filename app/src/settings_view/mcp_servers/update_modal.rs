...
use wish_core::ui::external_product_icon::ExternalProductIcon;
use wish_core::ui::icons::Icon;
use wish_core::ui::theme::color::internal_colors;
use wishui::elements::{Align, Empty, Padding, Shrinkable};
...
impl UpdateModalBody {
    ...
    fn render_action_buttons(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let corner_down_left_icon = Container::new(
            ConstrainedBox::new(Icon::CornerDownLeft.to_wishui_icon(label_color).finish())
