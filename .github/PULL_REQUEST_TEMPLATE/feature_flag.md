...
- [ ] No performance regression on dev. Link the relevant Hermon AI performance dashboard or local benchmark output.
- [ ] Feature works fine, and no regression, over SSH. See [instructions](https://github.com/hermonai/wish-internal/tree/master/app/tests/ssh/README.md) on how to get a VM.
...
- [ ] [Telemetry entry](https://wish.hermon.ai/docs) (if applicable)
