...
- `app/src/ui_components/icon_with_status.rs` — `IconWithStatusVariant`, `render_icon_with_status`, `render_with_cloud_status_badge`, `HERMON_AMBIENT_BACKGROUND_COLOR`, sub-component size ratios.
...
- `crates/wish_cli/src/agent.rs` — `Harness` enum, `Harness::config_name` / `Harness::from_config_name`.
