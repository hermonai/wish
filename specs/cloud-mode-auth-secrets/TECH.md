...
- `crates/wish_graphql` — cynic-based GraphQL query modules. **Will add** `list_harness_auth_secrets` query module.
...
**New file**: `crates/wish_graphql/src/queries/list_harness_auth_secrets.rs`
