...
In `crates/wishui_core/src/elements/image.rs`, add an optional failed-state element to `Image`:
...
- Extend or add `crates/wishui_core/src/elements/image_tests.rs` coverage for:
