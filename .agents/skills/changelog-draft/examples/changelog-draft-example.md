...
- Conversation details side panel is now available for local Warp Agent conversations, not just cloud Hermon runs. Click the info button in the pane header to open it for any active AI conversation. ([#9493](https://github.com/warpdotdev/warp/pull/9493))
...
- Added `--version` flag support in the Hermon CLI ([#9252](https://github.com/warpdotdev/warp/pull/9252))
...
*This draft was generated by the `changelog-draft` Hermon skill. Needs Review and Skipped PRs are available in the JSON audit artifact.*
