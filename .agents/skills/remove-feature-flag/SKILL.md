...
description: Remove a feature flag after it has been rolled out and stabilized in the Wish codebase.
---

# remove-feature-flag

Remove a feature flag after it has been rolled out and stabilized in the Wish codebase.
...
Remove the variant from the `FeatureFlag` enum in `crates/warp_features/src/lib.rs`:
...
```bash
rg "YourFeatureName" app/ crates/warp_features/
```
