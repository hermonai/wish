...
use wishui::{keymap::Keystroke, Entity, ModelContext, ModelHandle, ViewContext};
...
/// This struct is a wrapper around the VimFSA that turns it into a wishui::Entity. We want to keep
/// the VimFSA independent of our UI framework, so anything involving wishui should live here
/// instead.
#[derive(Default)]
pub struct VimModel {
    fsa: VimFSA,
