...
fn get_agent_modality_callout_options(
    ...
    match state {
        ...
        AgentModalityCalloutState::NaturalLanguageSupport => {
            ...
            if initial_natural_language_detection_enabled {
                ...
                Some(CalloutOptions {
                    ...
                    text: format!(
                        "Natural language input is off by default. If enabled, you can type requests in plain English and Wish will autodetect queries for the agent. You can always override them using {}.",
                        keybindings.toggle_input_mode
                    ),
                    step: StepStatus::new(1, total_steps),
                    left_button: None,
        ...
        AgentModalityCalloutState::IntroducingAgentExperience => Some(CalloutOptions {
            title: "Introducing Wish's new agent experience",
