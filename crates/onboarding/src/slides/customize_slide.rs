...
impl CustomizeUISlide {
    ...
    pub(crate) const VISUAL_IMAGE_PATHS: &'static [&'static str] = &[
        ...
        "async/png/onboarding/agent_intention/customize_wishdrive_vertical.png",
        "async/png/onboarding/agent_intention/customize_wishdrive_horizontal.png",
        ...
        "async/png/onboarding/terminal_intention/terminal_customize_wishdrive_vertical.png",
        "async/png/onboarding/terminal_intention/terminal_customize_wishdrive_horizontal.png",
                ...
                if !ui.tools_panel_enabled(&intention) {
                    ...
                    if is_agent {
                        match (chip, vertical) {
                            ...
                            (ToolsPanelSubSetting::WarpDrive, true) => "async/png/onboarding/agent_intention/customize_wishdrive_vertical.png",
                            (ToolsPanelSubSetting::WarpDrive, false) => "async/png/onboarding/agent_intention/customize_wishdrive_horizontal.png",
                        }
                    } else {
                        ...
                        match (chip, vertical) {
                            ...
                            (ToolsPanelSubSetting::WarpDrive, true) => "async/png/onboarding/terminal_intention/terminal_customize_wishdrive_vertical.png",
                            (ToolsPanelSubSetting::WarpDrive, false) => "async/png/onboarding/terminal_intention/terminal_customize_wishdrive_horizontal.png",
                        }
                    }
                }
            }
