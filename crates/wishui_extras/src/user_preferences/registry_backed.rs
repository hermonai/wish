...
impl RegistryBackedPreferences {
    ...
    /// Gets Wish's registry key, creating it if it does not already exist.
    fn get_wish_registry(&self) -> Result<Key, super::Error> {
