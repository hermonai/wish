...
use wish_core::ui::{Icon, appearance::Appearance, theme::color::internal_colors};
use wishui::{
...
fn main() -> wishui::platform::app::TerminationResult {
    ...
    app_builder.run(move |ctx| {
        ...
        let font_family = wishui::fonts::Cache::handle(ctx).update(ctx, |cache, _ctx| {
        ...
        ctx.add_window(wishui::AddWindowOptions::default(), RootView::new);
    })
}
                ...
                LightboxImage {
                    source: LightboxImageSource::Resolved {
                        asset_source: AssetSource::Bundled {
                            path: "bundled/png/hermon-logo.png",
                        },
                    },
                    description: Some("First image (hermon-logo.png)".to_string()),
                },
                LightboxImage {
                    source: LightboxImageSource::Resolved {
                        asset_source: AssetSource::Bundled {
                    ...
                    description: Some("Second image (also hermon-logo.png)".to_string()),
                },
            ],
...
impl View for RootView {
    ...
    fn keymap_context(&self, _: &AppContext) -> wishui::keymap::Context {
        ...
        tooltip::Tooltip.render(
            ...
            tooltip::Params {
                ...
                options: tooltip::Options {
                    keyboard_shortcut: Some(wishui::keymap::Keystroke {
                        ctrl: true,
                        key: "k".to_string(),
                        ..Default::default()
                    }),
                ...
                self.default_button_row.default.render(
                    ...
                    button::Params {
                        ...
                        options: button::Options {
                            keystroke: Some(wishui::keymap::Keystroke {
                                ctrl: true,
                                key: "k".to_string(),
                                ..Default::default()
                            }),
        ...
        self.dialog.render(
            ...
            dialog::Params {
                ...
                options: dialog::Options {
                    ...
                    dismiss_keystroke: Some(wishui::keymap::Keystroke {
                        key: "escape".to_string(),
                        ..Default::default()
                    }),
