...
/// A type alias for the concrete type stored within a wishui
...
pub fn register(service_name: &str, ctx: &mut wishui::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut wishui::AppContext) {
...
impl wishui::Entity for Model {
    type Event = ();
}

impl wishui::SingletonEntity for Model {}
...
impl AppContextExt for wishui::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
