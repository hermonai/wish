...
impl TryFrom<wish_graphql::object::ObjectType> for ObjectIdType {
    type Error = anyhow::Error;
    fn try_from(object_type: wish_graphql::object::ObjectType) -> Result<Self, Self::Error> {
        match object_type {
            wish_graphql::object::ObjectType::AIConversation => Err(anyhow!(
                "AIConversation is not a supported object type for this operation"
            )),
            wish_graphql::object::ObjectType::Notebook => Ok(ObjectIdType::Notebook),
            wish_graphql::object::ObjectType::Workflow => Ok(ObjectIdType::Workflow),
            wish_graphql::object::ObjectType::Folder => Ok(ObjectIdType::Folder),
            wish_graphql::object::ObjectType::GenericStringObject => {
                Ok(ObjectIdType::GenericStringObject)
            }
            wish_graphql::object::ObjectType::Unknown => {
...
impl From<ObjectType> for wish_graphql::object::ObjectType {
    fn from(value: ObjectType) -> Self {
        match value {
            ObjectType::Notebook => wish_graphql::object::ObjectType::Notebook,
            ObjectType::Workflow => wish_graphql::object::ObjectType::Workflow,
            ObjectType::Folder => wish_graphql::object::ObjectType::Folder,
            ObjectType::GenericStringObject(GenericStringObjectFormat::Json(
                JsonObjectType::EnvVarCollection,
            )) => wish_graphql::object::ObjectType::GenericStringObject,
...
impl CloudObjectStatuses {
    ...
    pub fn render_icon(
        ...
        let icon_and_tooltip_text = if should_show_local_only_indicator {
            Some((
                Icon::Laptop.to_wishui_icon(theme.main_text_color(theme.surface_1())),
                SYNC_STATUS_TOOLTIP_LOCAL_ONLY,
            ))
        } else if should_show_syncing_indicator {
            Some((
                Icon::Refresh.to_wishui_icon(theme.sub_text_color(theme.surface_2())),
                SYNC_STATUS_TOOLTIP_INFLIGHT,
            ))
        } else if should_show_error_indicator {
            Some((
                Icon::AlertTriangle.to_wishui_icon(Fill::Solid(theme.ui_error_color())),
...
impl From<GenericStringObjectFormat>
    for wish_graphql::generic_string_object::GenericStringObjectFormat
{
...
impl From<CloudObjectEventEntrypoint> for wish_graphql::object::CloudObjectEventEntrypoint {
    fn from(entrypoint: CloudObjectEventEntrypoint) -> Self {
        use wish_graphql::object::CloudObjectEventEntrypoint as GraphQLEntrypoint;
        match entrypoint {
...
impl TryFrom<wish_graphql::object::ObjectMetadata> for ServerMetadata {
    type Error = anyhow::Error;

    fn try_from(value: wish_graphql::object::ObjectMetadata) -> Result<Self, Self::Error> {
        let folder_id: Option<FolderId> = match value.parent {
            wish_graphql::object::Container::FolderContainer(folder_container) => {
...
impl TryFrom<wish_graphql::object_permissions::ObjectPermissions> for ServerPermissions {
    type Error = anyhow::Error;

    fn try_from(
        value: wish_graphql::object_permissions::ObjectPermissions,
...
impl TryFrom<wish_graphql::object_permissions::ObjectGuest> for ServerObjectGuest {
    type Error = anyhow::Error;

    fn try_from(value: wish_graphql::object_permissions::ObjectGuest) -> Result<Self, Self::Error> {
...
impl TryFrom<wish_graphql::object_permissions::GuestSubject> for ServerGuestSubject {
    type Error = anyhow::Error;

    fn try_from(
        value: wish_graphql::object_permissions::GuestSubject,
    ) -> Result<Self, Self::Error> {
        match value {
            wish_graphql::object_permissions::GuestSubject::UserGuest(user_guest) => {
                let guest_subject = ServerGuestSubject::User {
                    firebase_uid: user_guest.firebase_uid.into_inner(),
                };
                Ok(guest_subject)
            }
            wish_graphql::object_permissions::GuestSubject::PendingUserGuest(guest) => {
                Ok(ServerGuestSubject::PendingUser { email: guest.email })
            }
            wish_graphql::object_permissions::GuestSubject::TeamGuest(team_guest) => {
                Ok(ServerGuestSubject::Team {
                    team_uid: ServerId::from_string_lossy(team_guest.uid.inner()),
                })
            }
            wish_graphql::object_permissions::GuestSubject::Unknown => {
...
impl TryFrom<wish_graphql::object_permissions::LinkSharing> for ServerLinkSharing {
    type Error = anyhow::Error;

    fn try_from(value: wish_graphql::object_permissions::LinkSharing) -> Result<Self, Self::Error> {
...
impl TryFrom<wish_graphql::object::Container> for ServerObjectContainer {
    type Error = anyhow::Error;

    fn try_from(value: wish_graphql::object::Container) -> Result<Self, Self::Error> {
        match value {
            wish_graphql::object::Container::FolderContainer(folder) => {
                Ok(ServerObjectContainer::Folder {
                    folder_uid: ServerId::from_string_lossy(folder.folder_uid.inner()),
                })
            }
            wish_graphql::object::Container::Space(space) => Ok(ServerObjectContainer::Drive {
                owner: space.try_into()?,
            }),
            wish_graphql::object::Container::Unknown => {
...
impl TryFrom<wish_graphql::object::Space> for Owner {
    type Error = anyhow::Error;

    fn try_from(value: wish_graphql::object::Space) -> Result<Self, Self::Error> {
        let owner = match value.type_ {
            wish_graphql::object::SpaceType::Team => Owner::Team {
                team_uid: ServerId::from_string_lossy(value.uid.inner()),
            },
            wish_graphql::object::SpaceType::User => Owner::User {
...
impl From<Owner> for wish_graphql::object_permissions::Owner {
    fn from(owner: Owner) -> Self {
        use wish_graphql::object_permissions::Owner as GraphQLOwner;
