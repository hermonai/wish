...
use wish_multi_agent_api::{self as api, response_event::stream_finished};
...
impl ModelTokenUsage {
    ...
    pub fn to_proto_wish_usage(&self) -> Option<(String, stream_finished::ModelTokenUsage)> {
