...
use wishui::elements::{Align, ConstrainedBox, ParentElement, Rect, Stack};
use wishui::fonts::FamilyId;
use wishui::SingletonEntity as _;
use wishui::{AppContext, Element, Entity, TypedActionView, View, ViewContext};
...
impl RootView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        let font_family = wishui::fonts::Cache::handle(ctx).update(ctx, |cache, _| {
            cache
