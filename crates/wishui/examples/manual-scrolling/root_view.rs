...
use wishui::elements::new_scrollable::AxisConfiguration;
use wishui::elements::new_scrollable::ClippedAxisConfiguration;
use wishui::elements::new_scrollable::DualAxisConfig;
use wishui::elements::new_scrollable::NewScrollableElement;
use wishui::elements::new_scrollable::ScrollableAppearance;
use wishui::elements::new_scrollable::ScrollableAxis;
use wishui::elements::Axis;

use wishui::elements::ChildView;
use wishui::elements::ClippedScrollStateHandle;
use wishui::elements::NewScrollable;
use wishui::elements::Point;
use wishui::elements::ScrollData;
...
impl Element for ScrollableElement {
    fn layout(
        &mut self,
        constraint: wishui::SizeConstraint,
        _: &mut wishui::LayoutContext,
        _: &AppContext,
    ) -> Vector2F {
        let size = vec2f(
    ...
    fn after_layout(&mut self, _: &mut wishui::AfterLayoutContext, _: &AppContext) {}

    fn paint(&mut self, origin: Vector2F, ctx: &mut wishui::PaintContext, _app: &AppContext) {
    ...
    fn dispatch_event(
        &mut self,
        _: &wishui::event::DispatchedEvent,
        _: &mut wishui::EventContext,
        _: &AppContext,
    ) -> bool {
        false
    }
...
impl NewScrollableElement for ScrollableElement {
    ...
    fn scroll(&mut self, delta: wishui::units::Pixels, axis: Axis, ctx: &mut wishui::EventContext) {
        match axis {
            Axis::Horizontal => (),
            Axis::Vertical => {
