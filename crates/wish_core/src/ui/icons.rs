...
/// Icon enum to be used within the app in place of the wishui::elements::Icon directly. It
...
pub enum Icon {
    ...
    Wish,
    WishLogo,
    HermonLogoTitleBlack,
    HermonLogoTitleWhite,
    HermonLogoRound,
    /// Deprecated aliases — use Wish/WishLogo instead
    WarpDrive,
    Warp,
    WarpLogoLight,
    ArrowLeft,
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::WishDrive => "bundled/svg/wish-drive.svg",
            Icon::Wish => "bundled/svg/hermon-logo.svg",
            Icon::WishLogo => "bundled/svg/hermon-logo.svg",
            Icon::HermonLogoTitleBlack => "bundled/svg/hermon-logo-title-black.svg",
            Icon::HermonLogoTitleWhite => "bundled/svg/hermon-logo-title-white.svg",
            Icon::HermonLogoRound => "bundled/svg/hermon-logo-round.svg",
            // Deprecated aliases — kept for compatibility
            Icon::WarpDrive => "bundled/svg/wish-drive.svg",
            Icon::Warp => "bundled/svg/hermon-logo.svg",
            Icon::WarpLogoLight => "bundled/svg/hermon-logo.svg",
            ...
            Icon::Warping0 => "bundled/svg/wish-loading-0.svg",
            Icon::Warping1 => "bundled/svg/wish-loading-1.svg",
            Icon::Warping2 => "bundled/svg/wish-loading-2.svg",
            Icon::Warping3 => "bundled/svg/wish-loading-3.svg",
            Icon::Warping4 => "bundled/svg/wish-loading-4.svg",
            Icon::Warping5 => "bundled/svg/wish-loading-5.svg",
            Icon::Warping6 => "bundled/svg/wish-loading-6.svg",
            Icon::Warping7 => "bundled/svg/wish-loading-7.svg",
            Icon::Warping8 => "bundled/svg/wish-loading-8.svg",
            Icon::Warping9 => "bundled/svg/wish-loading-9.svg",
            Icon::Warping10 => "bundled/svg/wish-loading-10.svg",
            Icon::Warping11 => "bundled/svg/wish-loading-11.svg",
...
impl Icon {
    ...
    /// Compatibility alias for upstream Warp-derived call sites.
    ///
    /// Wish keeps this method so frequent upstream merges do not require
    /// mechanically rewriting every icon renderer during each sync.
    pub fn to_warpui_icon(self, color: Fill) -> WarpUiIcon {
        self.to_wishui_icon(color)
    }

    pub fn icon_for_key(key: &str) -> Option<WarpUiIcon> {
        match key {
            "⏎" => Some(Self::CornerDownLeft.to_wishui_icon(Fill::black())),
            _ => None,
        }
    }
}
