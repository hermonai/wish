...
integration_tests! {
    ...
    test_launch_wish_with_theme_in_wish_config,
    #[cfg(target_os="macos")]
    test_preview_config_dir_migration,
    #[ignore = "Flakes in CI"]
    test_add_launch_config_to_wish_config,
    #[ignore = "Flakes in CI"]
    test_add_workflows_to_wish_config,
    #[ignore = "Flakes in CI"]
    test_add_theme_to_wish_config,
    ...
    // run. Ignore for now.
    #[ignore]
    test_ask_wish_ai_keybinding_for_selected_block,
