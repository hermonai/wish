...
* You can copy over a warp.sqlite file from ~/Library/Application\ Support/{warp, dev.warp.Wish-(Dev|Preview|Stable)} directly
* You may want to sanitize some info that is specific to you (i.e. cwd https://staging.hermon.ai/block/FNBafyVtxvjmdNIx6HxUM5)
