...
use wish::integration_testing::view_getters::{terminal_view, workspace_view};
use wish::integration_testing::window::{
    add_and_save_window, assert_num_windows_open, save_active_window_id,
};
use wish::integration_testing::workspace::{
...
fn vertical_tab_pane_row_position_id(app: &mut wishui::App, window_id: WindowId) -> String {
...
fn first_vertical_tab_pane_row_position_id(app: &mut wishui::App, window_id: WindowId) -> String {
...
fn dispatch_mouse_event(app: &mut wishui::App, window_id: WindowId, event: Event) {
...
fn tab_bounds(app: &mut wishui::App, window_id: WindowId, tab_index: usize) -> RectF {
    let presenter = app.presenter(window_id).expect("presenter should exist");
...
fn tab_center(app: &mut wishui::App, window_id: WindowId, tab_index: usize) -> Vector2F {
...
) -> impl FnMut(&mut wishui::App, WindowId) -> AssertionOutcome {
    move |app, _| {
