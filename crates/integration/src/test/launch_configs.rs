...
use wish::search::command_palette::launch_config;
use wish::workspace::NEW_TAB_BUTTON_POSITION_ID;
use wish::{features::FeatureFlag, integration_testing::settings::set_window_custom_size};
use wish::{
            ...
            new_step_with_default_assertions("Opening a configuration template").with_action(
                move |app, _, _| {
                    app.dispatch_global_action(
                        ...
                        wish::root_view::OpenLaunchConfigArg {
                            launch_config:
                                wish::launch_configs::launch_config::make_mock_single_window_launch_config(),
...
pub fn test_launch_config_single_child_branch() -> Builder {
    use wish::launch_configs::launch_config::{
